...
class apiConfig extends config {
    ...
    function __construct($data=null){
        ...
        $config->DB->TABLE->RECHARGE=$PREFIX.'recharge';
        ...
        $config->FRAME->ROOT_PROJECT='Api';//为空则默认根目录//当前项目主目录 controler.class.php , model.class.php 调用
        ...
        $config->FRAME->URL_TYPE='Rewrite';//地址栏格式
